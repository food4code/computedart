...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GalleryImage.sold'
        db.add_column('galleries_galleryimage', 'sold',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GalleryImage.sold'
        db.delete_column('galleries_galleryimage', 'sold')
    ...
    models = {
        ...
        'galleries.galleryimage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sold': ('django.db.models.fields.IntegerField', [], {'default': '0', 'blank': 'True'})
        },
